...
public:
    ...
    LayeredHSMOMDP(SeekerHSParams* params);
    virtual ~LayeredHSMOMDP();
    ...
    */
    ...
    Segmenter* getSegmenter() const;

    void setSegmenterX(Segmenter* segmenter);

    Segmenter* getSegmenterX() const;
    ...
    int getNextAction(Pos seekerPos, Pos hiderPos, bool visible, int actionDone);

    virtual vector<int> getNextMultipleActions(Pos seekerPos, Pos hiderPos, bool opponentVisible, int actionDone, int n);
