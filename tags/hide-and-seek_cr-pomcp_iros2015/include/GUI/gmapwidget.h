...
protected slots:
     ...
     * \param gameStatus
     */
    void handleServerUpdateReceived(int oppRow, int opCol, int gameStatus);
...
private:
    ...
    //! vector of dyn obst (auto walkers)
    //std::vector<IDPos> _dynObstVec;
    //AG140525: use GMap.getDynamicObstacles
