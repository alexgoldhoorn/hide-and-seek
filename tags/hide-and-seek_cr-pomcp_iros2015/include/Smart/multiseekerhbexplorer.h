...
/*!
 * \brief The MultiSeekerHBExplorer class This class should implement the behaviour of a seeker doing find-and-follow.
 ...
 *
 */
class MultiSeekerHBExplorer : public HighestBeliefFollower
{
public:
