...
./expbatch2.py pomdpx pol maps "12x12:1,2,3,4" "i$x" "6 45 0 0" "-T 300 -Tr -Tf -grx 6 45 0 0 -s localhost 1121" "sim3_2c_grx" v

# smart seeker:
./expbatch3.py pomdpx pol maps "12x12:1,2,3,4" "i$x" "12 45 0 0" "-T 300 -s localhost 1121" "sim4" v
...
rar m -m5 ~/Temp/logs_130508_sim3_grx.rar *log
