...
./hsmomdp -ss -m $map -u SmartSeeker -s 192.168.100.220 1123 -oh > smartseeker_i$x_mapbcn$m_allksmarth.log &
sleep 10
...
# all know. VERY smart 2
./hsmomdp -ss -m $map -u SmartSeeker -s 192.168.100.220 1123 -oh > smartseeker_i$x_mapbcnfull_allksmarth.log &
sleep 10
