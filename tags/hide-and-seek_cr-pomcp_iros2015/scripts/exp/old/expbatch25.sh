...
./expbatch.py pomdpx off2 maps "10x10:1,2,3,4" "i$x" "10 45 0 0" "-T 300 -d 20 " "maxd20"

./expbatch.py pomdpx off2 maps "10x10:1,2,3,4" "i$x" "10 45 0 0" "-T 300 -d 100 " "maxd100"
