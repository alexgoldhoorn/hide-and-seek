...
bool Player::move(int action) {
    ...
    Pos newPos = _map->tryMove(action,_curPos);//player being in position position takes action action and moves to a new position
...
void Player::printInfo() {
    ...
    cout << " type="<<_type<</*";hiderType="<<_hidertype<<*/";curpos="<<_curPos.toString()<<"; oppos="<<_player2Pos.toString()<<";#actions="<<_numActions<<";lastAction="<<_action<<endl;
    _map->printMap(_curPos); //ag130301: other syntax printmap
