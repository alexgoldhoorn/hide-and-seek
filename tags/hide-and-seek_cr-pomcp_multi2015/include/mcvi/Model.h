...
class Model
{
  public:
    ...
    */
    virtual bool allowableAct(Belief const& belief, MAction const& act) = 0;
    ...
    */
    virtual double sample(MState const& currState, MAction const& act, MState& nextState, MObs& obs, RandStream& randStream) = 0;
    ...
    /**
       ...
       @param[in] randSource Source of random numbers
    */
    virtual double sample(MState const& currState, MAction const& macroAct, long controllerState, MState& nextState, long& nextControllerState, MObs& obs, RandStream& randStream) = 0;
    ...
    /**
       ...
       @param[in] randSource Source of random numbers
    */
    virtual double initPolicy(MState const& currState, MAction const& initAction, long controllerState, MState& nextState, long& nextControllerState, MObs& obs, RandStream& randStream) = 0;
    ...
    /**
       ...
       the state.
    */
    virtual double upperBound(MState const& state) = 0;

    /**
     * Probability for seeing observation obs when arrived state nextState.
     */
    virtual double getObsProb(MAction const& act, MState const& nextState, MObs const& obs) = 0;
    ...
    */
    virtual obsType getObsType(MObs const& obs) = 0;

    /**
       Sets the type of the observation: LoopObs, TermObs or OtherObs.
    */
    virtual void setObsType(MObs& obs, obsType type) = 0;

    /**
       @return Whether this state a terminal state
    */
    virtual bool isTermState(MState const& state) = 0;
    ...
    */
    virtual long getObsGrpFromObs(MObs const& obs) { return 0; }
