...
public:
     ...
     * \return
     */
    virtual bool checkNextStateObs(const State* state, const State* nextState, const Observation* obs) const=0;
     ...
     * \return
     */
    virtual bool isStateConsistentWithObs(const State* state, const Observation* obs) const=0;
