...
public:
  ...
  */
  void runSingle(long length, double& sumReward, double& sumDiscounted, std::string trace_fn, MState startState,  RandStream& randStream, long rootIndex = 0);
  ...
  */
  void runSingle(long length, double& sumDiscounted, MState startState, PolicyGraph::Node *currNode, RandStream& randStream);
