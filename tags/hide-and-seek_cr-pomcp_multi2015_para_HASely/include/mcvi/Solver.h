...
class Solver {
  public:
    ...
    void solve(Model& currModel, std::vector<MState> &initialBeliefStates, std::vector<long> &pathLength);
    void solve(Model& currModel, std::vector<MState> &initialBeliefStates, MObs& obs, std::vector<long> &pathLength);

    void solve(Model& currModel, MState& initialBeliefState, long pathLength);
    void solve(Model& currModel, MState& initialBeliefState, MObs& obs, long pathLength);
