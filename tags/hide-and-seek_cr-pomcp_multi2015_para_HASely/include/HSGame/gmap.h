...
public:
    ...
    //constants for hidden zones
    static const int HiddenZone1        = 1;
    static const int HiddenZone2        = 2;
    static const int HiddenZone3        = 3;
    static const int HiddenZone4        = 4; 
    static const int HiddenZone5        = 5;
    static const int HiddenZone6        = 6;
    static const int HiddenZone7        = 7;
    static const int HiddenZone8        = 8; //10; //not definable on map
    static const int HiddenZone9        = 9; //11; //idem
    static const int HiddenZone10        = 10;
    static const int HiddenZone11        = 11; //10; //not definable on map
    static const int HiddenZone12        = 12; //11; //idem
    static const int HiddenZone13        = 13; //11; //idem
    static const int HiddenZone14        = 14; //11; //idem
    static const int HiddenZone15        = 15; //11; //idem
    ...
    //! get item of map (cells are composed by 2 ittems on the row)
    char getItem2(int row1, int col1, int row2, int col2) const;

    //! set item of map (obstacle or not)
    void setItem(int row, int col, char c);

    //! set item of map for Hidden Zone division 
    void setItemHiddenZonesMap(int row, int col, char c);
    ...
    void printMapHz(bool showDynObst=true, int sr=-1,int sc=-1, int hr=-1, int hc=-1, std::ostream& stream = std::cout); // print map with hidden zones.
    ...
    std::vector<Pos> getInvisiblePoints(const std::vector<Pos>& posVec, bool checkDynObst);
