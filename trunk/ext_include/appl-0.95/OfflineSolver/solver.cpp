...
{
    DEBUG_LOG(cout << "Starting APPL solver"<<endl<<"Debug log is ON"<<endl<<endl;); //ag120223: debug


	//try
	{
                //DEBUG_LOG(cout << "Loading SolverParams: "<<flush;); //ag120223: debug
		SolverParams* p = &GlobalResource::getInstance()->solverParams;
                //DEBUG_LOG(cout << "ok loaded solverparams"<<endl;); //ag120223: debug
        ...
        //AG121016: show params before solving
        if (p->showParams) p->showAllParams();
