...
//#define CB_INITIALIZATION_PRECISION_FACTOR (1e-2) //AG120423: moved to SARSOP.h as a const, since it is only used there (now this value used as default)
