...
namespace momdp
{
     ...
     void Sample::setup(PointBasedAlgorithm* _solver, SharedPointer<MOMDP> _problem, vector <BeliefCache *> *_beliefCacheSet, BeliefForest* _beliefForest)
     {
         solver = _solver;
         problem = _problem;
     ...
     void Sample::appendOnGetNodeHandler(GetNodeCallback _callback)
     {
     ...
     list<cacherow_stval> Sample::sample(cacherow_stval beliefIndex, unsigned int currentRoot) // modified for factored, prevly, virtual list<int>
     {
