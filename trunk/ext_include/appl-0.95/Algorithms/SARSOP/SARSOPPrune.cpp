...
namespace momdp 
{
    SARSOPPrune::SARSOPPrune( SARSOP* _solver) :Prune(_solver)
    {
    ...
    void SARSOPPrune::onLowerBoundBackup (PointBasedAlgorithm* solver, BeliefTreeNode * node, SharedPointer<AlphaPlane> backupResult)
    {
        // updating certs, etc
    }

    // Migrated from AlphaPlane
    bool SARSOPPrune::hasMaxMetaAt(SharedPointer<AlphaPlane> alphaPlane, int index)
    {
