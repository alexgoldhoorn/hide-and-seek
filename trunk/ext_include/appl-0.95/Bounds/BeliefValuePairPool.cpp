...
void BeliefValuePairPool::setBeliefCache(BeliefCache *p) {
    beliefCache = p;
}
void BeliefValuePairPool::setDataTable(IndexedTuple<BeliefValuePairPoolDataTuple> *p) {
    dataTable = p;
}

void BeliefValuePairPool::setProblem(SharedPointer<MOMDP> p) {
    problem = p;
}
void BeliefValuePairPool::setSolver(PointBasedAlgorithm *p) {
    //solver = p;
}

BeliefValuePairPool::BeliefValuePairPool(Backup<BeliefValuePair> *_backupEngine) {
    this->setBackupEngine(_backupEngine);
    cornerPointsVersion = 0;
}

BeliefValuePairPool::~BeliefValuePairPool(void) {
}


SharedPointer<BeliefValuePair> BeliefValuePairPool::backup(BeliefTreeNode * node) {
