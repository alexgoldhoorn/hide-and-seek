...
void BackupBeliefValuePairMOMDP::setProblem(SharedPointer<MOMDP> p) {
    problem = p;
}
void BackupBeliefValuePairMOMDP::setSolver(PointBasedAlgorithm *p) {
    //solver = p;
}
void BackupBeliefValuePairMOMDP::setBound(PointBasedAlgorithm *p) {
