...
public:
    ...
    //virtual int getNextAction(Pos seekerPos, Pos hiderPos, bool hiderVisible, int actionDone=-1);
...
protected:
     ...
     * \return
     */
    double score(const Pos& seekerPos, const Pos& hiderPos); //int sr, int sc, int hr, int hc);
     ...
     * \return
     */
    bool scoreForAction(const Pos& seekerPos, const Pos& hiderPos, int a, double& score); //int sr, int sc, int hr, int hc, int a, bool visib, double& s);


    //! slightly more intelligent score: averages over all possible hider pos/actions
    double scoreForState(const Pos& seekerPos, const Pos& hiderPos, const Pos& prevSeekerPos); //int sr, int sc, int hr, int hc, int srp, int scp);
