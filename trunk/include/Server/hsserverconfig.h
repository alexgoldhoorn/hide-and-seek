...
/*!
 * \brief The HSServerConfig class Contains the server configuration read from an xml file.
 */
...
private:
    ...
    //AG160126
    //! simulate not always seeing the person based on distance
    //! (using the prob. of visibility ( P(v|d) -> prob. of being visible given a depth)
    bool _simNotVisibDist;

    //AG160127
    //! parameters for sim. not visib. prob based on dist.
    double _simNotVisibDist_y0, _simNotVisibDist_x0, _simNotVisibDist_k0;
};
