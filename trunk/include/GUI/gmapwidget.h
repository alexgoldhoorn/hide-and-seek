...
public:
    ...
    //AG160509: auto play times
    static const int AUTO_PLAY_DEFAULT_MS = 1000;
    static const int AUTO_PLAY_CHANGE_MS = 200;
...
private:
    ...
    //! neighborhood (default 8)
    int _neighborhood;

    //AG160509
    //! timer to automatically continue next step without moving
    QTimer _autoPlayTimer;

    //! timeout of auto player
    int _autoPlayerTimerTime_ms;
};
