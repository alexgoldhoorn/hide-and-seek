...
protected:
    ...
    //AG170815
    //store belief image (and check if parameter has '#' to indicate it has an index)
    void storeMapBeliefAsImage(AutoPlayer* autoPlayer);
...
private:
     ...
     * \param thisDynObstPosXYVec
     * \param otherSeekerPosXYVec
     * \param otherSeekerHiderObsPosXYVec
     * \params otherDynObstPosXYVecVec
     */
    void getSeerkHSPosXYForAll(PosXY& thisSeekerPosXY, PosXY& thisSeekerHiderObsPosXY, std::vector<PosXY>& thisDynObstPosXYVec,
