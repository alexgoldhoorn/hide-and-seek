...
//AG160120: use for warnings
#ifdef DEBUG_WARN_ON
    #define DEBUG_WARN(v) v
#else
    #define DEBUG_WARN(v)
#endif
...
#ifdef DEBUG_FILTER_ON
    #define DEBUG_FILTER(v) v
#else
    #define DEBUG_FILTER(v)
#endif

#ifdef DEBUG_FILTER_WRITE_PARTICLES_ON
    #define DEBUG_FILTER_WRITE_PARTICLES(v) v
#else
    #define DEBUG_FILTER_WRITE_PARTICLES(v)
#endif
