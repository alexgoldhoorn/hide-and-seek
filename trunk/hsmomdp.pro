...
#DEFINES += DEBUG_FILTER_ON
#DEFINES += DEBUG_WARN_ON
...
CONFIG(debug, debug|release) {
    DESTDIR = build/debug/$${COMP_SUBDIR}/
} else {
    DESTDIR = build/release/$${COMP_SUBDIR}/
}
...
#    src/PathPlan/astar/astar.cpp \
        ...
        src/Filter/particlefilterplayer.cpp \
        src/Filter/particle.cpp \
        src/Filter/particlefilterchecker.cpp\
        src/Filter/hsparticlefilterchecker.cpp \
        src/Utils/posscoremat.cpp
...
SOURCES += test/src/HSGame/pos-test.cpp \
    ...
    test/src/PathPlan/astarpathplanner-test.cpp\
    test/src/Utils/posscoremat-test.cpp
...
HEADERS += test/include/HSGame/pos-test.h \
    ...
    test/include/PathPlan/astarpathplanner-test.h\
    test/include/Utils/posscoremat-test.h
