...
std::normal_distribution<double> __gausDoubleDistr;
...
{
    decltype(__gausDoubleDistr.param()) new_params (mean, std);
    __gausDoubleDistr.param(new_params);
    return __gausDoubleDistr(__randomGenerator);
}
