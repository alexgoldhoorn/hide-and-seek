...
CombinedSeeker::CombinedSeeker(SeekerHSParams* params, AutoPlayer *autoPlayerForVisib, AutoPlayer *autoPlayerForNotVisib, bool deleteAutoPlayers) :
    ...
    _deleteAutoPlayer(deleteAutoPlayers)
{
...
CombinedSeeker::~CombinedSeeker(){
    if (_deleteAutoPlayer) {
        delete _autoPlayerForNotVisib;
        delete _autoPlayerForVisib;
    }
