...
vector<int>* Segmenter::connectionAnalysis(vector<int>* vecSeg, bool ignoreObstacles) {
    ...
    */
    ...
    //TODO: AG160303: this probably does NOT work when there are U-shape obstacles where
    // the vertical lines are longer than 1, then it would need more iterations!!!
