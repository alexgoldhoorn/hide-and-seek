...
TABLE_WIDTH = 86
TABLE = "SimPOMCPOct2013p9" #"SimMay2013ss"
...
"""select concat_ws(',',SeekerType2,Reward,HiderCat3 ), sum(IsWin) as Win, sum(IsLose) as Lose, sum(IsTie) as Tie, count(*) as Total
from <TABLE>
group by SeekerType2,HiderCat3,Reward
order by SeekerType2,Reward,HiderCat3"""],
...
"""select concat_ws(',',explorationConst,Reward), sum(IsWin) as Win, sum(IsLose) as Lose, sum(IsTie) as Tie, count(*) as Total
from <TABLE>
group by explorationConst,Reward"""],
["tab x5: expandCount",
...
"""select concat_ws(',',MapSize,explorationConst,Reward), sum(IsWin) as Win, sum(IsLose) as Lose, sum(IsTie) as Tie, count(*) as Total
from <TABLE>
group by MapSize,explorationConst,Reward"""],
...
"""select concat_ws(',',MapSize,depth,Reward,explorationConst,expandCount), sum(IsWin) as Win, sum(IsLose) as Lose, sum(IsTie) as Tie, count(*) as Total
from <TABLE>
group by MapSize,depth,Reward,explorationConst,expandCount"""],
["tab x3b: Reward,explorationConst,expandCount",
"""select concat_ws(',',Reward,explorationConst,expandCount), sum(IsWin) as Win, sum(IsLose) as Lose, sum(IsTie) as Tie, count(*) as Total
from <TABLE>
group by Reward,explorationConst,expandCount"""],
...
qry_win_maps = """select concat_ws(',',OnOffline, SeekerType2,Reward,MapSize), sum(IsWin) as Win, sum(IsLose) as Lose, sum(IsTie) as Tie, count(*) as Total
from <TABLE>
where MapSize='<MAPSIZE>'
group by OnOffline,SeekerType2,Reward,MapSize"""
...
["tab1b: on/off seek type, hider type",
"""select concat_ws(',',SeekerType2,Reward,HiderCat3 ), <COL>
from <TABLE>
where IsWin=1 and MapSize='<MAPSIZE>'"""],
...
"""select concat_ws(',',depth,Reward,explorationConst,expandCount ), <COL>
from <TABLE>
where IsWin=1 and MapSize='<MAPSIZE>'"""],
["tabx2b: Reward,explorationConst,expandCount",
"""select concat_ws(',',Reward,explorationConst,expandCount ), <COL>
from <TABLE>
where IsWin=1 and MapSize='<MAPSIZE>'"""]
]
