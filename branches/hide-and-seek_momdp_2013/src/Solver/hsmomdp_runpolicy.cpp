...
#include "hsmomdp_runpolicy.h"

#include "Utils/generic.h"

#include "exceptions.h"

RunPolicyHSMOMDP::RunPolicyHSMOMDP() : HSMOMDP() {
...
vector<int> RunPolicyHSMOMDP::getNextMultipleActions(Pos seekerPos, Pos hiderPos, bool opponentVisible, int n) {
