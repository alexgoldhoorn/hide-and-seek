...
bool oldPOMDP::getIsTerminalState(const BeliefWithState&) const {
    throw runtime_error("");
}
outcome_prob_vector& oldPOMDP::getOutcomeProbVector(outcome_prob_vector&, const BeliefWithState&, int, int) const {
    throw runtime_error("");
}
BeliefWithState& oldPOMDP::getNextState(BeliefWithState&, const BeliefWithState&, int, int, int) const {
    throw runtime_error("");
}
double oldPOMDP::getReward(const BeliefWithState&, int) const {
    throw runtime_error("");
}
