...
select l.FileName, l.info, 
	...
	count(*) nLines -- how many lines per data point
from (
...
/*
select MapName,MaxActions,Seeker,WinStatus,avg(Duration) as Duration_avg,std(Duration) as Duration_std,avg(NumActions) as NumActions_avg,
	std(NumActions) as NumActions_std, count(*) n
from GameListDetail
